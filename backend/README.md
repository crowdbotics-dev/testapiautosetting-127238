...
## Project Structure
    ...
    ├── testapiautosetting_127238  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127238`
...
2. Clone this repo and `cd testapiautosetting_127238`
